 ...
 *
 */
public class VisualLoop3 extends Application implements Runnable {
//Loop Parameters
...
//LOOP
    ...
    private void update() {
        ...
        } else if (inputKeyboard.contains("O")) {
        ...
        //MASUKKAN CODING UNTUK ROTASI

	    if (inputKeyboard.contains("Y")) {
            sudutRotasi += 2;//Merotasi Kotak se arah gerakan jarum jam sudutRotasi+=2;
        }
        //MASUKKAN CODING UNTUK GERAK JATUH BEBAS
        ...
        //CODING AGAR KOTAK BERGERAK KE ATAS KETIKA MENEKAN SPASI
